...
if(isset($_POST['submit_course'])){
  addCourse($_POST['course_name'], $_POST['units'], $_POST['seats'] , $_POST['course_description']);
  $message = "New Course added";
echo "<script type='text/javascript'>alert('$message');</script>";
header("location: course.php?del=0");
}

if($_REQUEST['del']==12){
  deleteCourse($_REQUEST['row']);
...
<link href="../assets/css/style.css" rel="stylesheet">
        ...
        <div class="header-container d-flex align-items-center">
          ...
          <nav class="nav-menu d-none d-lg-block">
            <ul>
              ...
              <li class="active" ><a href="course.php?del=0">Course</a></li>
  ...
  <br>
    ...
    <form method="post" class="php-email-form mt-4">
        <h1 class="text-green">Add Course</h1>
        <div class="form-group">
          <input type="text" class="form-control" name="course_name" placeholder="Course Name" required />
<br>
        <div class="form-row">
          <div class="col-md-6 form-group">
            <input type="text" name="units" class="form-control" placeholder="Course units: 1-6" required  />
  ...
  <input type="text" class="form-control" name="course_description" placeholder="Description" required />

      <div class="mb-3">

      </div>

      <div class="text-center"><button type="submit" name="submit_course">Add new Course</button></div>
    </form>
...
<br>
  ...
  echo "<h1 style='text-transform: capitalize;'>" . $row['name'] . "</h1>";
  echo "<h6>" . $row['description'] . "</h6>";
  echo "<br>";
  echo "<h5>Seats</h5>";
  echo "<h6 style='text-transform: capitalize;'>".$row['seats']."</h6>";
  echo "<br>";
  echo "<h5>Units</h5>";
  echo "<h6 style='text-transform: capitalize;'>".$row['units']."</h6>";
  echo "<a style='float:right' href='course.php?row=$rowid & del=12 '>Delete</a>";
  echo "<br>";
  echo "</div>";
}
  ?>
