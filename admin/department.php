...
if(isset($_POST['submit_department'])){
  addDepartment($_POST['department_name'],$_POST['department_description']);
        ...
        <div class="header-container d-flex align-items-center">
          ...
          <nav class="nav-menu d-none d-lg-block">
            <ul>
              ...
              <li class="active" ><a href="department.php?del=0">Department</a></li>
...
<br>
    ...
    <form method="post" class="php-email-form mt-4">
        <h1 class="text-green">Add department</h1>
      <div class="form-group">
        <input type="text" class="form-control" name="department_name" placeholder="Department Name" required /> <br>
          <input type="text" class="form-control" name="department_description" placeholder="Description" required />
      <div class="mb-3">

      </div>

      <div class="text-center"><button type="submit" name="submit_department">Add new Department</button></div>
    </form>
...
<br>
  ...
  <?php
  $arr = getAllDepartments();
  while($row=mysqli_fetch_assoc($arr)){
  $rowid = $row['id'];
  echo "<div class='info mt-4'>";
  echo "<h3 style='text-transform: capitalize;' >".$row['department_name']."</h3>";
  echo "<h6>".$row['description']."</h6>";
  echo "<a style='float:right' href='department.php?row=$rowid & del=12 '>Delete</a>";
  echo "<br>";
  echo "</div>";
}
  ?>
